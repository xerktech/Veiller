...
reach Veiller's central Cloud Core through it (with OEM-scoped auth), and if the
OEM self-hosts Veiller Runtime Services, the proxy routes those requests to their
own instance instead of Veiller's.
...
- [`../001-cloud-core/`](../001-cloud-core/): always Veiller-hosted, reached through
  the proxy.
