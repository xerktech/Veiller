...
Umbrella issue for **Veiller Cloud Core Services** (`@veiller/cloud-core`): the
proprietary cloud product Veiller runs centrally for the whole ecosystem. OEMs
...
- [`auth/`](./auth/): the whole auth system. OEM auth (the RFC 8693 token
  ...
  (Veiller-direct and OEM), miniapp auto-auth, and dev console / store sign-in.
...
- [`../../veiller-overhaul-plan.md`](../../veiller-overhaul-plan.md): product and
  service taxonomy.
