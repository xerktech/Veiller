 ...
 * top-level ESM `export` is a SyntaxError there. `@veiller/miniapp/background`
 ...
 * with no externals.
 *
 * Build-time env vars: any `VEILLER_PUBLIC_*` key in your shell or
 ...
 * rather than in VEILLER_PUBLIC_*.
 *
 ...
 *
 * Output goes to ./dist with the shape `veiller-miniapp release` expects.
 */

import {rm} from "fs/promises"
import {backgroundRuntimeGuardPlugin, reactSingletonPlugin} from "@veiller/miniapp-cli/build-helpers"
...
// Pick up VEILLER_PUBLIC_* env vars from the shell / .env. Bun loads .env
