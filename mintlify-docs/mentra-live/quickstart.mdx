---
title: "Quickstart"
description: "Install the Veiller Bluetooth SDK and connect a mobile app to smart glasses."
icon: "rocket"
---
...
Select version `0.1.21-beta.3`, then add the `VeillerBluetoothSDK` product to your app target.
...
In React components, use `useVeillerBluetooth()` to render the current connection and status state:
