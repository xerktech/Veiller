---
title: "iOS"
description: "Use the Veiller Bluetooth SDK from a native iOS app."
icon: "apple"
---

Native iOS apps use the `VeillerBluetoothSDK` Swift package.
...
In Xcode, choose **File > Add Package Dependencies**, enter that URL, select version `0.1.21-beta.3`, and add the `VeillerBluetoothSDK` product to your app target.
