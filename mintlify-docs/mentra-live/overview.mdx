...
The Veiller Bluetooth SDK is the base SDK for building mobile apps that control Mentra Live directly over Bluetooth. It gives Android, iOS, and React Native apps access to scanning, pairing, device status, microphone audio, camera capture, speaker playback, streaming, Wi-Fi, and hardware events.

Use this SDK when your app owns the mobile experience and needs a direct phone-to-glasses connection.

In Summer 2026, we'll release Veiller 3.0, a new SDK for building apps that run on the phone. Learn more in the [Veiller Roadmap June blogpost](https://mentraglass.com/blogs/blog/veiller-roadmap-update-moving-to-miniapps-on-the-phone).
...
| React Native / Expo | `@veiller/bluetooth-sdk` | `import BluetoothSdk from '@veiller/bluetooth-sdk'` |
