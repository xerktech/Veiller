...
description: "Validate a mobile app before shipping with the Veiller Bluetooth SDK."
icon: "clipboard-check"
---

Use this checklist before shipping an app with the Veiller Bluetooth SDK.

## Analytics

- Veiller Bluetooth SDK usage analytics are enabled by default and use Veiller's embedded PostHog project write key.
