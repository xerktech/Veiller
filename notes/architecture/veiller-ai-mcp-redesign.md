...
This document outlines a complete redesign of the Veiller tool calling system, replacing the current bespoke LangChain-based implementation with a modern Mastra + MCP architecture.
...
│                         ┌───────────────┼───────────────┐       │
│                         ▼               ▼               ▼       │
│                   NewsAgent      VeillerAgent     OtherAgents    │
│                         │               │                       │
│                         └───────┬───────┘                       │
│                                 ▼                               │
│                    Tool Discovery (REST)                        │
...
export interface MCPToolDefinition {
  ...
  /** Veiller extensions (not part of MCP spec) */
  veillerExtensions?: {
...
import { MCPToolDefinition } from "@veiller/sdk"
...
import { MCPToolCall, MCPToolResult } from "@veiller/sdk"
import { Logger } from "pino"
...
import { MCPToolCall } from "@veiller/sdk"
...
The Mentra AI mini-app is a **first-party app** that uses the Veiller SDK. It:
...
class VeillerAIApp extends AppServer {
  private agent: Agent
