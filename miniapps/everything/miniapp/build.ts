...
define["process.env.MENTRA_PUBLIC_EVERYTHING_BACKEND_URL"] = JSON.stringify(
  process.env.MENTRA_PUBLIC_EVERYTHING_BACKEND_URL ?? "",
)
...
console.log("built local-everything -> dist/background/index.js + dist/ui + dist/icon.png + dist/miniapp.json")
