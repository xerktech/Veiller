 ...
 * the bottom nav for {@link HOLD_DURATION_MS}. Developer-only chrome (the cloud
 * + backend status pills, the live debug tray, and the Developer info button)
 * stays hidden until this flips on, keeping the default UI looking like a
 * native app rather than a debug console.
 *
