// Veiller scene-display backend — implements `GlassesDisplay` over
...
// without importing @veiller/miniapp.
...
// keeping this module free of an @veiller/miniapp import.
...
export interface VeillerDisplaySession {
...
export class VeillerDisplay implements GlassesDisplay {
  private readonly session: VeillerDisplaySession;
  ...
  constructor(session: VeillerDisplaySession) {
