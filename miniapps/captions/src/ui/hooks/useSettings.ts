...
export function useSettings() {
  ...
  const updateCaptionTimeoutSeconds = async (seconds: number): Promise<boolean> => {
    ...
    veiller.send("captions:set-caption-timeout", {seconds})
    return true
  }
