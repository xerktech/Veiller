...
// the regular Mentra build (bundle: com.xerktech.veiller.stable, label: "stable").
...
console.log(chalk.blue(`MENTRAOS_BUILD_NAME=stable (bundle: com.xerktech.veiller.stable)`))
