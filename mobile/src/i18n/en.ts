const en = {
  ...
  versionCheck: {
    ...
    updateRequiredDescription: "Your version of the Veiller app is no longer supported. Please update to continue.",
    updateRequiredButton: "Update the Veiller App",
    updateAvailableTitle: "Update Available",
    updateAvailableDescription:
      "A newer version of the Veiller app is available. We recommend updating for the best experience.",
    update: "Update",
    ...
    upToDateDescription: "Veiller is up to date. Returning to home...",
  },
  simulatedGlasses: {
  ...
  pairing: {
    ...
    simulatedGlassesDescription: "Simulated Glasses allows you to run Veiller without physical smart glasses.",
  ...
  onboarding: {
    ...
    liveEndOnboardingMessage: "You'll continue to the Veiller tutorial.",
    ...
    osWelcomeTitle: "Welcome to Veiller",
    osWelcomeSubtitle: "Learn how to use apps on your glasses",
    osEndTitle: "You're all set",
    osEndSubtitle: "Enjoy Veiller on your smart glasses",
    ...
    osMissingMiniappDescription: "Some miniapps aren't available in this version of the Veiller App.",
    ...
    learnAboutOs: "Learn about Veiller",
    ...
    unpairEvenSubtitle: "To use Veiller, forget your glasses in Bluetooth settings. Unpair them, then try again.",
  ...
  ota: {
    ...
    updateInfoUnavailableMessage:
      "Update information for this version of the app is unavailable. Please check the app store for a newer version of the Veiller App.",
  ...
  permissions: {
    backgroundLocationPermissionRequiredMessage:
      'Veiller needs access to your location when the app is in the background to provide location-based features. On the next screen, select Location, then select "Always" instead of "While Using the App"',
    openSettings: "Open Settings",
    permissionRequired: "Permission Required",
  ...
  miniappStore: {
    title: "Miniapp Store",
    description: "Choose which miniapps install and stay up to date. Turn one off to pause its updates.",
    ...
    stageChecking: "Checking for the latest version…",
    stageDownloading: "Downloading…",
    stageInstalling: "Installing…",
    installSucceeded: "Installed v{{version}} ✓",
    updateSucceeded: "Updated to v{{version}} ✓",
    installFailedStatus: "Failed: {{error}}",
    installFailedTitle: "Install failed",
    installFailedMessage: "Couldn't install {{appName}}: {{error}}",
  },
  settings: {
    title: "Account",
    ...
    privacyPolicySubtitle: "Read how Veiller collects and uses your data.",
    leaveAppTitle: "Leave Veiller?",
    leaveAppMessage: "This link will open in your browser, outside the Veiller app. Continue?",
    ...
    notificationsSubtitle: "Allow Veiller to forward your phone notifications to your smart glasses.",
    ...
    notificationsDescription:
      "Control which apps can send notifications to Veiller. When enabled, notifications from these apps will be available to Veiller.",
    ...
    dashboardWidgetCalendarSubtitle: "Show your upcoming calendar events. Requires calendar access.",
    dashboardWidgetNewsLabel: "News Widget",
    dashboardWidgetNewsSubtitle: "Show the glasses' built-in news page.",
    dashboardWidgetStocksLabel: "Stocks Widget",
    dashboardWidgetStocksSubtitle: "Show the glasses' built-in stocks page.",
    dashboardWidgetTasksLabel: "Tasks Widget",
    dashboardWidgetTasksSubtitle: "Show the glasses' built-in quicklist of tasks.",
    dashboardWidgetHealthLabel: "Health Widget",
    dashboardWidgetHealthSubtitle: "Show the glasses' built-in health page.",
    ...
    glassesControls: "Glasses Controls",
    glassesControlsVoiceGroup: "Voice",
    glassesControlsDeviceGroup: "Device",
    heyEvenLabel: '"Hey Even" Wake Word',
    heyEvenSubtitle: "Let the glasses respond to the built-in “Hey Even” voice assistant. Off by default.",
    wearDetectionLabel: "Wear Detection",
    wearDetectionSubtitle: "Turn the display off automatically when you take the glasses off.",
    silentModeLabel: "Silent Mode",
    silentModeSubtitle: "Mute the audio cue the glasses play on notifications.",
  ...
  profileSettings: {
    ...
    deleteAccountWarning1Message:
      "You are about to permanently delete your Veiller account. This action is IRREVERSIBLE.",
  ...
  login: {
    ...
    login: "Login",
    connectingToServer: "Connecting to Veiller...",
  ...
  warning: {
    ...
    betaBuild:
      "You are using a beta version of Veiller. Some features may have issues or work differently than in the production version.",
  ...
  feedback: {
    ...
    experienceRating: "Rate your experience with Veiller",
    ratingScale: "1 - low & 5 - high",
    feedbackLabel: "Feedback",
    shareThoughts: "Share your thoughts",
    continue: "Continue",
    submit: "Submit",
    rateApp: "Rate Veiller",
    rateAppMessage:
      "We're so glad you're enjoying Veiller! Would you mind rating us on the app store? It really helps us out.",
    notNow: "Not Now",
    rateNow: "Rate Now",
  ...
  tapTester: {
    ...
    inputPlaceholder: "Tap here, then type with your Tap Strap…",
    inputHint: "Type with the standard Tap Strap gestures. Text mirrors to the glasses.",
    clear: "Clear",
    status: "Status",
    supported: "Tap SDK supported",
    bluetoothPermission: "Bluetooth permission",
    pairedStraps: "Paired straps",
    ...
    no: "No",
    none: "None",
    controllerModeOnNote: "Controller mode was on — disabled so taps type as a keyboard. Restored on exit.",
    eventLog: "Event log",
    clearLog: "Clear log",
    noEvents: "No events yet. Start tapping.",
    battery: "battery",
  },
  appInfo: {
