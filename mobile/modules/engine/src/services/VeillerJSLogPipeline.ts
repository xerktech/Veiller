/**
 * VeillerJSLogPipeline — the three log-side utilities that
 * VeillerJSRouter's `__log` handler runs every miniapp log line through:
 *
 ...
 *
 *   2. VeillerJSLogThrottle — token-bucket rate limiter, 100 lines/min
 ...
 *
 *   3. VeillerJSLogRingBuffer — fixed-size circular buffer (default 200)
...
export class VeillerJSLogThrottle {
 ...
 */
export class VeillerJSLogRingBuffer {
