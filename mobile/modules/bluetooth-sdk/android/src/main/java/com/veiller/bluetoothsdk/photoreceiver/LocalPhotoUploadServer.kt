package com.veiller.bluetoothsdk.photoreceiver
...
class LocalPhotoUploadServer(
    ...
    private val uploadDir = File(appContext.cacheDir, "veiller-photo-uploads")
        ...
        socket.use { client ->
            ...
            try {
                ...
                if (request.method == "GET" && (request.path == "/" || request.path == "/health")) {
                    respond(200, """{"ok":true,"service":"veiller-photo-upload-receiver"}""")
                    return
                }
