...
internal class BluetoothSdkAnalytics(
    ...
    private val executor: ExecutorService = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "VeillerBluetoothSdkAnalytics").apply { isDaemon = true }
    }
    ...
    private fun baseProperties(activeConfig: BluetoothSdkAnalyticsRuntimeConfig): Map<String, Any> =
        buildMap {
            ...
            put("event_source", "veiller_bluetooth_sdk")
    ...
    private fun distinctId(): String {
        ...
        val generated = "veiller-bt-sdk-${UUID.randomUUID()}"
    ...
    companion object {
        internal const val META_ANALYTICS_DISABLED = "com.veiller.bluetoothsdk.analytics.disabled"
        private const val PREFS_NAME = "veiller_bluetooth_sdk_analytics"
