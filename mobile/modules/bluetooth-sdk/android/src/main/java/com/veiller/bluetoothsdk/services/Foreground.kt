package com.veiller.bluetoothsdk.services
...
class ForegroundService : Service() {
    companion object {
        const val CHANNEL_ID = "VeillerServiceChannel"
        const val NOTIFICATION_ID = 1001
        const val ACTION_REFRESH_TYPES =
                "com.veiller.bluetoothsdk.services.action.REFRESH_FOREGROUND_SERVICE_TYPES"
    }
    ...
    private fun detectServiceType(): Int {
        ...
        // active on the existing Veiller service for the entire connected
