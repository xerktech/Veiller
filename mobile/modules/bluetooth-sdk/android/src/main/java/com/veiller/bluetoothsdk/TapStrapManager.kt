 ...
 * interact with the phone at all while Veiller owns them. Glasses control on top of
...
object TapStrapManager {
    ...
    /**
     * Toggle Veiller takeover of paired Tap Straps.
     *
    ...
    private fun startSdk() {
        ...
        try {
            ...
            // Manual lifecycle: Veiller keeps straps taken over while the toggle is on,
