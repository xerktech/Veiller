...
declare class VeillerLocalNetworkNativeModule extends NativeModule<LocalNetworkEvents> {
...
export default requireOptionalNativeModule<VeillerLocalNetworkNativeModule>("VeillerLocalNetwork")
