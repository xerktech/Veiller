...
export type UseVeillerBluetoothOptions = {
...
export type VeillerBluetoothSession = {
  busy: boolean
...
export function useVeillerBluetooth(options: UseVeillerBluetoothOptions = {}): VeillerBluetoothSession {
