/**
 * @fileoverview VeillerProvider — optional root provider for miniapp apps.
 *
...
export interface VeillerProviderProps {
  children: ReactNode
  /**
...
export function VeillerProvider({children, syncColorScheme = true}: VeillerProviderProps) {
