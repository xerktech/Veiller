package com.veiller.recovery.health;
...
/**
 * In-process install pause signaling between {@link com.veiller.recovery.work.RecoveryWorker} and
 * {@link com.veiller.recovery.service.RecoveryService}. Avoids permission-gated broadcasts for
