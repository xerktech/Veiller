HeartbeatManager: Improved WebSocket Reconnection Design
  ...
  This document outlines the design for an improved WebSocket connection management system in Veiller Cloud, focusing on proper disconnect
