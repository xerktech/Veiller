...
description: "Everything you need to know to build apps with the Veiller SDK"
---

## Installation

Install the Veiller SDK using Bun:
...
The Veiller SDK provides two main classes:
...
const server = new MyAppServer({
  ...
  apiKey: process.env.VEILLER_API_KEY!,    // Your API key from dev portal
...
<Steps>
  ...
  <Step title="Cloud sends webhook">
    Veiller Cloud sends a webhook to your server
  </Step>
