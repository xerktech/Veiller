...
description: "Persistent key-value storage for Veiller Apps with local caching and cloud sync"
---

## Overview

The Simple Storage module provides a localStorage-like interface for Veiller Apps to persistently store configuration data, user preferences, and small datasets. Data is automatically synchronized between your app server and the Veiller Cloud, with intelligent local caching for optimal performance.
...
<AccordionGroup>
  <Accordion title="Data Not Persisting">
    ...
    - Verify network connectivity between your server and Veiller Cloud
  </Accordion>
