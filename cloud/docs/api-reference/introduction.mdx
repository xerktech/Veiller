---
title: 'API Reference'
description: 'Veiller Cloud API endpoints and WebSocket connections'
---

## Overview

Veiller Cloud provides both WebSocket and REST APIs:
...
```typescript
const ws = new WebSocket('wss://cloud.veiller.com/glasses-ws', {
  headers: {
...
```bash
curl -X GET https://api.veiller.com/user/profile \
...
The Veiller SDK handles all API communication for you:
