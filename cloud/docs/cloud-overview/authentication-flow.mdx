...
Let's follow a user named Alex as they open the Veiller mobile app and connect their smart glasses to the cloud. This journey shows how authentication works and how WebSocket connections are established.

## Step 1: Mobile App Login

When Alex opens the Veiller app on their phone:
...
2. **Opens WebSocket to cloud** at `wss://cloud.veiller.com/glasses-ws`
