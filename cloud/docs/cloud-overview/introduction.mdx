...
Welcome to the brain of Veiller! If you're reading this, you're about to learn how smart glasses, mobile apps, and third-party applications all work together to create magical experiences for users.

## What is Veiller?

Veiller is an ecosystem that connects:
...
4. **Building on Veiller** - How apps plug into the system
...
## What Makes Veiller Cloud Special?
...
Remember: The best way to understand Veiller Cloud is to follow the data. Every action starts with a user, flows through our system, and results in something magical happening on their glasses.