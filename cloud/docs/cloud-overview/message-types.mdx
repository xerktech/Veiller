...
In Veiller Cloud, everything happens through messages. Think of them as the conversations between glasses, cloud, and apps. Let's learn the language!
...
Now you understand the language of Veiller! Next, let's see [how apps connect](./5-sdk-and-apps.md) and use these messages to create amazing experiences.