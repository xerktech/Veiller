# Building on Veiller: SDK and Apps

Third-party apps are what make Veiller magical. They extend the glasses' capabilities from simple translation to AI assistants, note-taking, navigation, and more. Let's see how apps connect and interact with the system.

## The Veiller SDK

The SDK (`@veiller/sdk`) is a TypeScript/JavaScript library that makes it easy for developers to build apps. Think of it as the translator between apps and our cloud.
...
const session = new AppSession({
  ...
  apiKey: process.env.VEILLER_API_KEY,
  cloudUrl: 'wss://cloud.veiller.com/app-ws'
});
...
Now you know how apps work! You're ready to build your own Veiller applications using the SDK.