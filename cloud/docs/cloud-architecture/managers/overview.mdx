...
description: "Understanding the manager pattern in Veiller Cloud"
---

## Overview

Veiller Cloud uses a Manager pattern to organize functionality within UserSessions. Each manager is responsible for a specific domain of functionality, encapsulating related state, logic, and operations. This pattern promotes separation of concerns, maintainability, and testability.
