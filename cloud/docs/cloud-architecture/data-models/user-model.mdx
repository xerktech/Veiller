---
title: "User Model"
description: "Core user data model for Veiller Cloud"
---

## Overview

The User model is the central data structure representing Veiller users. It stores authentication data, preferences, installed apps, and system settings.
