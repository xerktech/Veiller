...
The App model represents third-party applications (TPAs) in the Veiller ecosystem. It stores app metadata, authentication credentials, webhook configurations, and app store status.
...
app.reviewedBy = 'reviewer@veiller.com';
