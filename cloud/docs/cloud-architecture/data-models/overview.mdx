...
description: "MongoDB schemas and data structures in Veiller Cloud"
---

## Overview

Veiller Cloud uses MongoDB for persistent storage of users, apps, photos, and system data. All models are defined using Mongoose schemas and follow consistent patterns for timestamps, references, and data validation.
...
### User Model
The central model representing Veiller users with their preferences, installed apps, and system settings.
...
### App Model
Represents third-party applications available in the Veiller ecosystem.
