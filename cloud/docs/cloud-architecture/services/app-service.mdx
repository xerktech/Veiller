---
title: "App Service"
description: "Core service for managing third-party applications in Veiller"
---

## Overview

The AppService (`app.service.ts`) is the central registry and management system for all third-party applications (TPAs) in Veiller. It handles app discovery, authentication, webhook interactions, and maintains the app ecosystem.
