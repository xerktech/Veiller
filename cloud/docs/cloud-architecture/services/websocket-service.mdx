...
The WebSocket Service is the central hub for all real-time communication in Veiller Cloud. It manages two separate WebSocket servers - one for smart glasses connections and another for third-party app connections.
