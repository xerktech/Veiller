...
The UserSession class is the central object that represents an active user connection in Veiller Cloud. It encapsulates all session-related state, managers, and functionality for a single user, serving as the hub for all user interactions.
