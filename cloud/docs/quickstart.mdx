---
title: "Quick Start"
description: "Get your first Veiller app running in 5 minutes"
---
...
<Steps>
  ...
  <Step title="Veiller App">
    Install the Veiller mobile app and connect your smart glasses
  </Step>
</Steps>
...
class MyAppServer extends AppServer {
  protected async onSession(
    ...
    await session.layouts.showTextWall('Hello from Veiller!');
...
<Steps>
  ...
  <Step title="Start the App">
    In the Veiller mobile app, say "Start [your app name]"
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/1-overview"
  >
    Understand how Veiller Cloud works under the hood
  </Card>
  <Card
    title="Message Types"
    icon="message"
