...
description: "Run Veiller Cloud locally for development and testing"
---

## Overview

This guide helps you set up Veiller Cloud on your local machine for development. You'll learn how to configure the environment, expose your local server using ngrok, and connect the mobile app to your development cloud instance.
...
- **Veiller mobile app** installed on your phone
- A Veiller account
...
MONGO_URL=mongodb://localhost:27017/veiller
# For MongoDB Atlas (cloud):
# MONGO_URL=mongodb+srv://username:password@cluster.mongodb.net/veiller?retryWrites=true&w=majority
...
```bash
# Connect to MongoDB
mongosh mongodb://localhost:27017/veiller
...
Veiller includes two web applications for app management:
...
1. **Store**: http://localhost:5173
   - Sign in with your Veiller account
