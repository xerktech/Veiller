...
interface GetVeillerButtonProps {
  className?: string
  size?: "small" | "medium" | "large"
  variant?: "default" | "outline"
}

const GetVeillerButton = ({className = "", size = "medium", variant = "default"}: GetVeillerButtonProps) => {
  ...
  return (
    <Button
      ...
      aria-label="Download Veiller">
      <img src={iconSrc} alt="Veiller" className={iconSizes[size]} />
      Get Veiller
    </Button>
  )
}

export default GetVeillerButton
